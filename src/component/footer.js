          ...
          <div className="flex items-center justify-center md:justify-start gap-3 text-zinc-300">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold">
                <span className="bg-gradient-to-b font-opensans  from-red-400 to-red-700 bg-clip-text text-transparent font-extrabold">...SO<span className=' bg-gradient-to-bl text-transparent from-green-600 to-85% to-white bg-clip-text font-cursive'>Filmy</span>
              </span></span>
