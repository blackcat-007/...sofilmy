...
const Profile = () => {
  ...
  return (
    <>
      <div className="max-w-md w-80  sm:w-auto ml-11 sm:mx-auto mt-10 p-6 bg-gradient-to-br from-[#1a1a1a] to-[#141414] border border-gray-800 rounded-xl shadow-lg text-center">
        <img 
